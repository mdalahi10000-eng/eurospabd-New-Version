      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        ...
        <div>
          ...
          <div className="bg-white rounded-2xl border border-gray-200 overflow-hidden p-3.5 shadow-xs">
            {/* Map Preview Graphic matching Clean Minimalism */}
            <div 
            ...
            >
              {/* Map background texture with streets */}
              ...
              <svg className="absolute inset-0 w-full h-full stroke-gray-300 fill-none" xmlns="http://www.w3.org/2000/svg">
                <path d="M-20 40 Q 120 70 300 30 T 600 60" strokeWidth="4" stroke="#d5ded7" />
                <path d="M40 -20 L 80 180" strokeWidth="3" stroke="#d5ded7" />
                <path d="M220 -20 L 190 180" strokeWidth="3" stroke="#d5ded7" />
                <path d="M-10 110 L 400 110" strokeWidth="2.5" stroke="#cbd5e1" />
              </svg>
            ...
            {/* Get Directions Button - Clean Blue Accent */}
            <button
            ...
            <div className="space-y-3 pt-0.5">
              ...
              >
                <div className="w-7 h-7 rounded-full bg-green-50 flex items-center justify-center shrink-0 group-hover:bg-green-100 transition-colors">
                  <svg className="w-3.5 h-3.5 text-green-600 fill-current" viewBox="0 0 24 24">
