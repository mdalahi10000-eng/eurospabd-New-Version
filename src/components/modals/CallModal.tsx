...
export function CallModal({ isOpen, onClose, onWhatsAppClick, businessInfo }: CallModalProps) {
  ...
  const hoursDisplay = businessInfo?.displayStatus || `Open ${SPA_INFO.openingHours} daily`;
