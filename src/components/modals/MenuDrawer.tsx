...
/>
                ...
                <div>
                  <h3 className="font-bold text-base text-white tracking-wide">
                    {businessInfo?.businessName || SPA_INFO.name}
                  </h3>
                  <p className="text-[11px] text-gray-300">
                    {businessInfo ? `${businessInfo.area}, ${businessInfo.city} • ${businessInfo.displayStatus}` : `${SPA_INFO.locationShort} • 10:00 AM – 10:00 PM`}
                  </p>
                </div>
              </div>
            ...
            <div className="p-4 space-y-1">
              ...
              <button
                ...
                className="w-full flex items-center gap-3 px-3 py-2.5 rounded-xl text-gray-700 hover:bg-blue-50 hover:text-blue-900 transition-colors text-xs sm:text-sm font-semibold text-left cursor-pointer"
              >
              ...
              <button
                ...
                className="w-full flex items-center gap-3 px-3 py-2.5 rounded-xl text-gray-700 hover:bg-purple-50 hover:text-purple-900 transition-colors text-xs sm:text-sm font-semibold text-left cursor-pointer"
              >
                ...
                <div className="mt-1 p-2 bg-gray-50 rounded-xl space-y-2 max-h-44 overflow-y-auto">
                  {loadingAppts ? (
                    ...
                    appointments.map((appt, idx) => (
                      <div key={appt.id || `appt-${idx}`} className="p-2 bg-white rounded-lg border border-gray-200 text-xs">
